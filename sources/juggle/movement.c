...
/*   Updated: 2024/05/16 17:51:33 by tjorge-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int is_colliding_in_y(t_cub *cub, float old_y)
{
	...
	if ((cub->player.y < old_y))
		flag = -1;
	if (cub->map.map[(int)(cub->player.y + FAT * flag)][(int)(cub->player.x + FAT)] == '1' \
		|| cub->map.map[(int)(cub->player.y + FAT * flag)][(int)(cub->player.x - FAT)] == '1')
		return (1);
	if (cub->map.map[(int)(cub->player.y + FAT * flag)][(int)(cub->player.x + FAT)] == '2' \
		|| cub->map.map[(int)(cub->player.y + FAT * flag)][(int)(cub->player.x - FAT)] == '2')
		return (1);
	return (0);
}
...
int is_colliding_in_x(t_cub *cub, float old_x)
{
	...
	if ((cub->player.x < old_x))
		flag = -1;
	if (cub->map.map[(int)(cub->player.y + FAT)][(int)(cub->player.x + (FAT * flag))] == '1' \
	|| cub->map.map[(int)(cub->player.y - FAT)][(int)(cub->player.x + (FAT * flag))] == '1')
		return (1);
	if (cub->map.map[(int)(cub->player.y + FAT)][(int)(cub->player.x + (FAT * flag))] == '2' \
	|| cub->map.map[(int)(cub->player.y - FAT)][(int)(cub->player.x + (FAT * flag))] == '2')
		return (1);
	return (0);
}
